function myFunction() {
  ...
  if (dots.style.display === "none") {
    ...
    btnText.innerHTML = "+ Se Mina Katter";
    moreText.style.display = "none";
  } else {
    dots.style.display = "none";
    btnText.innerHTML = "- Dölj Mina Katter";
...
function myFunctionFour() {
  ...
  let btnTextfour = document.getElementById("myBtnfour");

  if (dotsfour.style.display === "none") {
    dotsfour.style.display = "inline";
    btnTextfour.innerHTML = "+ Se Mina Katter";
    moreTextfour.style.display = "none";
  } else {
    dotsfour.style.display = "none";
    btnTextfour.innerHTML = "- Dölj Mina Katter";
